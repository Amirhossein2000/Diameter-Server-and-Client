...
// Copyright 2013-2015 go-diameter/v4 authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

// This file is auto-generated from our dictionaries.

// DefaultDict is a Parser object with pre-loaded
// Base Protocol and Credit Control dictionaries.
var DefaultDict *dict.Parser
...
func init() {
	...
	var err error
	DefaultDict, err = dict.NewParser()
	if err != nil {
		panic(err)
	}
	for _, d := range dictionaries {
		err = DefaultDict.Load(bytes.NewReader([]byte(d.xml)))
		if err != nil {
			panic(fmt.Sprintf("Cannot load %s dictionary: %s", d.name, err))
		}
	}
}
	...
	<application id="4" type="auth" name="Charging Control">
		...
		<command code="272" short="CC" name="Credit-Control">
			<request>
				...
				<rule avp="Called-Station-Id" required="true" max="1"/>
				<rule avp="TGPP-GPRS-Negotiated-QoS-Profile" required="true" max="1"/>
				<rule avp="Session-Id" required="true" max="1"/>
				<rule avp="Origin-Host" required="true" max="1"/>
				<rule avp="Origin-Realm" required="true" max="1"/>
				<rule avp="Destination-Realm" required="true" max="1"/>
		...
		<avp name="TGPP-GPRS-Negotiated-QoS-Profile" code="5" must="M" may="-" must-not="V" may-encrypt="Y">
			<!-- http://tools.ietf.org/html/rfc7155#section-4.2.5 -->
			<data type="UTF8String"/>
		</avp>
...
<diameter>
	...
	<application id="1" type="auth" name="Network Access">
		...
		<avp name="Called-Station-Id" code="30" must="M" may="-" must-not="V" may-encrypt="Y" vendor="0">
			<!-- http://tools.ietf.org/html/rfc7155#section-4.2.5 -->
			<data type="UTF8String"/>
		</avp>
	...
	<application id="4" type="auth" name="TGPP">
		...
		<avp name="Charging-Characteristics-Selection-Mode" code="2066" must="V,M" may="P" must-not="-" may-encrypt="N" vendor-id="10415">
			<data type="Enumerated">
				...
				<item code="3" name="Home-DefaultDict"/>
				<item code="4" name="Roaming-DefaultDict"/>
				<item code="5" name="Visiting-DefaultDict"/>
			</data>
		</avp>
		...
		<avp name="IP-Realm-DefaultDict-Indication" code="2603" must="V,M" may="P" must-not="-" may-encrypt="N" vendor-id="10415">
			<data type="Enumerated">
				<item code="0" name="DefaultDict IP Realm Not used"/>
				<item code="1" name="DefaultDict IP realm used"/>
			</data>
		</avp>
		...
		<avp name="SDP-Media-Component" code="843" must="V,M" may="P" must-not="-" may-encrypt="N" vendor-id="10415">
			<data type="Grouped">
				...
				<rule avp="IP-Realm-DefaultDict-Indication" required="false" max="1"/>
